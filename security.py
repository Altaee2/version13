...
async def setup_security(client, admins_list):
    ...
    async def admin_handler(event):
        ...
        # 6. قائمة المساعدة الاحترافية المزخرفة (.م8)
        elif text == ".م8":
            help_msg = """
...
‏┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉
**💡 ملاحظة هامة :**
هذه أوامر بسيطة متوفرة في السورس، إذا كنت تبحث عن **أوامر احترافية ومميزات قوية جداً** لحماية مجموعتك، يمكنك تنصيب بوت الحماية الخاص بنا من هنا:
🤖 **بوت الحماية:** @SORS_RECO_BOT
